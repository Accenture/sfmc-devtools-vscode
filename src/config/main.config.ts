export const mainConfig: {
  ...
  messages: {
    ...
    initDevTools:
      "Do you wish to initialize SFMC DevTools project in the current directory?",
    ...
    failureRunningCommand:
      "Oh no. Something went wrong while running DevTools Command.",
    unsupportedMetadataType:
      "SFMC DevTools currently does not support one or more of the selected metadata types.",
  },
};
