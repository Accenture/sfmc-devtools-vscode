...
const metadataTypesList: TDevTools.IMetadataTypes[] = [
	...
	},
	{
		...
		description: "Defines an audience based on specified rules. Used by Filter Activities."
	},
	{
		name: "Data Filter (auto-generated)",
		apiName: "dataFilterHidden",
		retrieveByDefault: false,
		supports: {
			retrieve: false,
			create: false,
		...
		description: "Defines an audience based on specified rules. Auto-generated by filtered DEs and filtered Lists."
	},
	{
		name: "Data Extension",
	...
	},
	{
		...
		description: 'Used in automations to filter lists and DEs. Depends on type "FilterDefinitions".'
	},
	{
		name: "Folder",
		apiName: "folder",
	...
	{
		name: "Triggered Send Summary",
		apiName: "triggeredSendSummary",
		retrieveByDefault: false,
		supports: {
			retrieve: true,
			create: false,
		...
		description: "Summary data for a Triggered Send"
	},
	{
		name: "User",
		apiName: "user",
