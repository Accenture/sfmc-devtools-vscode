export const metadatatypes = [
  ...
  },
  {
    ...
    "description": "DEPRECATED: Old way of saving Content Blocks; please migrate these to new Content Blocks (`Asset: ...`)."
  },
  {
    "name": "Data Extension",
  ...
  },
  {
    ...
    "description": "Description of all API endpoints accessible via REST API; only relevant for developers of Accenture SFMC DevTools."
  },
  {
    "name": "E-Mail (Classic)",
    "apiName": "email",
  ...
  },
  {
    ...
    "description": "Used for export or import of files to/from Marketing Cloud. Previously this was labeled ftpLocation."
  },
  {
  ...
  },
  {
    ...
    "description": "Used by Journey Builder and to send SMS from MobileConnect triggered by API or manually on-the-fly"
  },
  {
  ...
  },
  {
    ...
    "description": "Lets admins define Delivery Profile, Sender Profile and CAN-SPAM for an email job in a central location."
  },
  {
